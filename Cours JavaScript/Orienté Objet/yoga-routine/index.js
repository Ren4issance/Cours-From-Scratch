    ...
    updateCountdown() {
        ...
        return (main.innerHTML = `
            <div class="exercice-container">
                ...
                }.png" alt="Exercice ${exerciceArray[this.index].pic}">
    ...
    deleteItem: function () {
        document.querySelectorAll(".deleteBtn").forEach((btn) => {
            btn.addEventListener("click", (e) => {
                newArray = exerciceArray.filter((exo) => {
...
const page = {
    lobby: function () {
        ...
        utils.deleteItem();
        reboot.addEventListener("click", (e) => utils.reboot());
        start.addEventListener("click", (e) => this.routine());
    },
    routine: function () {
